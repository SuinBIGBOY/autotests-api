...
create_courses_response = courses_client.create_course(create_courses_request)
print("Create course data:", create_courses_response)

create_exercise_request = CreateExerciseRequestSchema(course_id=create_courses_response.course.id)
